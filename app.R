		...
		fluidRow(
			...
			column(2,
                ...
                sliderInput("isoEvent", "Event ISO",
                  min = 0, max = 10,
                  value = 1, step = 0.1)), br(),
                div(style="height: 40px;",sliderInput("iso2fofc", "2fofc ISO",
                  min = 0, max = 10,
                  value = 1.5, step = 0.1)),br(),
                div(style="height: 40px;",sliderInput("isofofc", "fofc ISO",
                  min = 0, max = 10,
                  value = 3, step = 0.1)),br(),
                hr(),
                numericInput("boxsize", 'Box Size', value = 10, min = 0, max = 100),
                numericInput("clipDist", "Clipping Distance", value=10, min = 0, max = 100),
                div(style="height: 40px;",sliderInput("fogging", "Fogging:",
                  min = 0, max = 100,
                  value = c(50,62))),br(),
                div(style="height: 40px;",sliderInput("clipping", "Clipping:",
                  min = 0, max = 100,
                  value = c(42,100))),br(),   
                hr()#,      

...
RUN R -e "library(remotes);remotes::install_github('tjgorrie/nglShiny');remotes::install_github('r-dbi/RPostgres')" 
...
# Run App?
CMD ["Rscript", "/srv/shiny-server/app.R", "0.0.0.0", "3838"]

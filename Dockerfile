...
# Install R packages
RUN R -e "install.packages(c('devtools', 'caTools','shiny','shinydashboard','shinyjqui','shinyWidgets','ggplot2','plotly','htmlwidgets', 'DT', 'remotes', 'httr', 'sendmailR', 'shinyjs'), repos='http://cran.rstudio.com/')"
